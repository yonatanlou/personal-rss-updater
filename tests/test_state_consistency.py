...
from rss_updater.monitoring.monitor import BlogMonitor
...
class TestStateConsistency:
    ...
    def test_post_url_change_detection(self):
        ...
        original_post = Post(
            title="Test Post",
            url="https://example.com/draft/post1",
            blog_name="Test Blog"
        )
        ...
        updated_post = Post(
            title="Test Post",
            url="https://example.com/published/post1",
            blog_name="Test Blog"
        )
    ...
    def test_failure_count_tracking(self):
        ...
        self.storage.update_blog_state(
            blog_name,
            last_post_title="Back to Success",
            failure_count=0
        )
    ...
    def _is_new_post(self, post: Post, blog_state: BlogState) -> bool:
        ...
        return not (
            post.title == blog_state.last_post_title and 
            post.url == blog_state.last_post_url
        )
