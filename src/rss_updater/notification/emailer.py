...
class EmailNotifier:
    ...
    def send_digest(self, new_posts: List[Post], stats: dict, failed_blogs_summary: str = "") -> bool:
        ...
        try:
            ...
            html_content = self.content_generator.create_html_content(new_posts, stats, failed_blogs_summary)
            text_content = self.content_generator.create_text_content(new_posts, stats, failed_blogs_summary)
    ...
    def send_biweekly_reminder(self, problematic_blogs: dict) -> bool:
        ...
        try:
            subject = f"RSS Monitor - Bi-weekly Reminder: {len(problematic_blogs)} blogs need attention"
